...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void login() async {
    ...
    final box = hiveService.studentBox;
    final user = box.values.firstWhere(
          (u) => u.username == emailController.text.trim() &&
    ...
    if (user != null) {
      await sessionService.saveUserSession(user.username);
      ...
      showMySnackBar(
          context: context, message: "Invalid Credentials", color: Colors.red);
    }
  }
